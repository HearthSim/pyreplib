...
const int BWrepAction::m_timeRatio = 23; 
...
const char *BWrepAction##classname::gGetParameters(const unsigned char *data, int datasize){\
...
IMPLACTION(Select,128)
	for(int i=0; i<(int)p->m_unitCount; i++)
	{
